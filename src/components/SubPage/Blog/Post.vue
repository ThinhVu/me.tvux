<template>
  <div class="w-100 bc-gray-1 ta-l pt-2">
    <!-- Avatar -->
    ...
    <!-- Content -->
    <div class="my-2 px-2 w-100 ovf-x-h markdown-body">
    ...
    <audio v-if="post.audio" :src="post.audio" controls/>

    <media-panel v-if="post.photos && post.photos.length" :photos="post.photos" height="700"/>
